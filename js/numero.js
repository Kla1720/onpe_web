                ...
                <div class="row">
                    <div class="col-xs-12 col-md-3">
                        <div class="menu-interna">
                            <ul>
                                <li><a href="actas_ubigeo.html">Actas por ubigeo</a></li>
                                <li><a href="actas_numero.html" class="act-izq">Actas por número</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-9" id="impreso">
                        <div class="contenido-interna">
                            ...
                            <div class="col-xs-12">
								...
								<p>&nbsp;</p>
								<p>&nbsp;</p>
								    <form id="myform" name="myform" class="horizontal-form" method="post">
											<div class="col-md-3">
											...
											<div class="col-md-4">
												<div class="form-group">
													<span id="spanNroMesa">
														<input id=${actas.idGrupoVotacion}"/>
													</span>
												</div>
											</div>

											<div class="col-md-2">
												<button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> BUSCAR</button>
											</div>
...
<div class="row">
    ...
    <div id="dvNombreDepartamento" class="col-md-3" style="">
        <div class="form-group">
            ...
            <div id="departamentos${actas.Departamento}"><select name="cdgoDep" id="cdgoDep" class="form-control">
            ...
            <div id="dvNombreProvincia" class="col-md-3" style="">
                <div class="form-group">
                    ...
                    <div id="provincias${actas.Provincia}">
    ...
    <div class="row">
        ...
        <div id="distritos${actas.Distrito}" class="form-group">
            ...
            <option value="140132">VILLA MARIA DEL TRIUNFO</option>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div id="divLocal${actas.RazonSocial}">    
                 ...
                 <div id="divDetalle" class="ptop20"><div class="col-xs-12 pbot30">
                    <p class="subtitle">LISTADO DE MESAS</p>
                                ...
                                <table>
                                <tbody><tr>
                                <td colspan="10"><div class="conte-paginador"><span class="paginador-txt">Total de mesas: ${ElectoresHabiles}16</span></div></td>
                                </tr>  
                                <tr><td>&nbsp;</td>
                                </tr>
                                <tr>
